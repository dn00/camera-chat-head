...
public class ChatHeadService extends Service {
	...
	private CameraGLView[] mCameraSurfaceView = new CameraGLView[1];
	...
	private void handleStart(){
		...
		chatheadView = (FrameLayout) inflater.inflate(R.layout.chathead, null);
		...
		mCameraSurfaceView[0] = (CameraGLView) chatheadView.findViewById(R.id.cameraView);
		mCameraSurfaceView[0].setCornerRadius(102);
