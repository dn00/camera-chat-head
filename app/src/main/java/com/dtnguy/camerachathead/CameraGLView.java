...
import com.dtnguy.camerachathead.encoder.MediaVideoEncoder;
import com.dtnguy.camerachathead.glutils.GLDrawer2D;
...
public final class CameraGLView extends GLSurfaceView {
    // TODO try using queueEvent for getting video frame
...
/*		// the frequency of refreshing of camera preview is at most 15 fps
     ...
     */
    private void setupEGLConfig(boolean translucent) {
        if (translucent) {
            setZOrderOnTop(true);
...
//********************************************************************************
    ...
    private static final class CameraSurfaceRenderer
        ...
        //private FrameListViewUpdater fUpdater;
        //private boolean requestOneVideoFrame;
        ...
        public CameraSurfaceRenderer(@NonNull final CameraGLView parent) {
            this(parent, new GLRoundedGeometry(), new RectF(-1, 1, 1, -1));
        }
        public CameraSurfaceRenderer(@NonNull CameraGLView parent,
            ...
            //fUpdater = new FrameListViewUpdater();
...
//            }
        ...
        public void onDrawFrame(final GL10 unused) {
            ...
            mDrawer.drawRound(hTex, mStMatrix,mUsesCoverageAa,mTriangleVertices,mTriangleIndices,mTriangleVerticesData,mTriangleVerticesData);
            flip = !flip;
            if (flip) {	// ~30fps
                synchronized (this) {
...
//				parent.requestRender();
    ...
    private static final class CameraHandler extends Handler {
        ...
        private static final int MSG_REQUEST_FRAME_LIST_VIEW_FRAME = 3;
        ...
        public void setRequestFLVTrue(final int width, final int height) {
            sendMessage(obtainMessage(MSG_REQUEST_FRAME_LIST_VIEW_FRAME));
        }
        ...
        public void handleMessage(final Message msg) {
            switch (msg.what) {
                ...
                case MSG_PREVIEW_STOP:
                    ...
                    mThread = null;
                    break;
                case MSG_REQUEST_FRAME_LIST_VIEW_FRAME:
                    mThread.setRequestFLVTrue();
                    break;
                default:
    ...
    private static final class CameraThread extends Thread{
        ...
        private boolean requestFLV;

        //private int temp = 0;
        public void setRequestFLVTrue() {
            requestFLV = true;
        }
//        @Override
...
//                        Rect area = new Rect(300, 300, 1000, 720);
//                        image.compressToJpeg(area, 10, out);
//                        Bitmap bm = BitmapFactory.decodeByteArray(out.toByteArray(), 0, out.size());
//                        parent.mRenderer.mVideoEncoder.addAFrame(bm);
//                    }
//                }).start();
//                requestFLV = false;
//            }
